...
<title>High-level Tests for 'element-citation'</title>
  ...
  <rule context="ref" id="ref">
    ...
    <let name="name" value="replace(replace(translate($name-1,'àáâãäåçčèéêëħìíîïłñòóôõöøřšśşùúûüýÿ','aaaaaacceeeehiiiilnoooooorsssuuuuyy'),'æ','ae'),'ß','ss')"/>
    ...
    <let name="name2" value="replace(replace(translate($name-2,'àáâãäåçčèéêëħìíîïłñòóôõöøřšśşùúûüýÿ','aaaaaacceeeehiiiilnoooooorsssuuuuyy'),'æ','ae'),'ß','ss')"/>
    ...
    <let name="preceding-name" value="replace(replace(translate($preceding-name-1,'àáâãäåçčèéêëħìíîïłñòóôõöøřšśşùúûüýÿ','aaaaaacceeeehiiiilnoooooorsssuuuuyy'),'æ','ae'),'ß','ss')"/>
    ...
    <let name="preceding-name2" value="replace(replace(translate($preceding-name-2,'àáâãäåçčèéêëħìíîïłñòóôõöøřšśşùúûüýÿ','aaaaaacceeeehiiiilnoooooorsssuuuuyy'),'æ','ae'),'ß','ss')"/>
