...
<title>High-level Tests for 'element-citation'</title>
  ...
  <rule context="ref" id="ref">
    ...
    <let name="name" value="replace(translate($name-1,'àáâãäåçčèéêëħìíîïłñòóôõöøšùúûüýÿ','aaaaaacceeeehiiiilnoooooosuuuuyy'),'æ','ae')"/>
    ...
    <let name="name2" value="replace(translate($name-2,'àáâãäåçčèéêëħìíîïłñòóôõöøšùúûüýÿ','aaaaaacceeeehiiiilnoooooosuuuuyy'),'æ','ae')"/>
    ...
    <let name="preceding-name" value="replace(translate($preceding-name-1,'àáâãäåçčèéêëħìíîïłñòóôõöøšùúûüýÿ','aaaaaacceeeehiiiilnoooooosuuuuyy'),'æ','ae')"/>
    ...
    <let name="preceding-name2" value="replace(translate($preceding-name-2,'àáâãäåçčèéêëħìíîïłñòóôõöøšùúûüýÿ','aaaaaacceeeehiiiilnoooooosuuuuyy'),'æ','ae')"/>
